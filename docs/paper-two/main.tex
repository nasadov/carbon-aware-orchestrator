...
\textbf{Kubernetes Integration:} The system interfaces with Kubernetes through the IDL protocol, which models cluster snapshots including node flavours, resource availability, and workload requirements. The gRPC interface enables polyglot implementation with Python-based algorithms and Go-based clients, facilitating integration with existing Kubernetes scheduler frameworks.
