...
class Microservice(_message.Message):
    __slots__ = ("name", "replicas", "cpu_required", "mem_required", "status", "deployed_on", "duration_hours", "deadline_hours")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    duration_hours: str
    deadline_hours: str
    def __init__(self, name: _Optional[str] = ..., replicas: _Optional[int] = ..., cpu_required: _Optional[_Union[ResourceQuantity, _Mapping]] = ..., mem_required: _Optional[_Union[ResourceQuantity, _Mapping]] = ..., status: _Optional[_Union[MicroserviceStatus, str]] = ..., deployed_on: _Optional[_Iterable[str]] = ..., duration_hours: _Optional[str] = ..., deadline_hours: _Optional[str] = ...) -> None: ...
