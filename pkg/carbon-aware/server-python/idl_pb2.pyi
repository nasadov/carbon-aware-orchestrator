...
class Microservice(_message.Message):
    __slots__ = ("name", "status", "deployed_on", "replicas", "cpu_required", "mem_required", "duration", "deadline")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    duration: str
    deadline: str
    def __init__(self, name: _Optional[str] = ..., status: _Optional[_Union[MicroserviceStatus, str]] = ..., deployed_on: _Optional[_Iterable[str]] = ..., replicas: _Optional[int] = ..., cpu_required: _Optional[_Union[ResourceQuantity, _Mapping]] = ..., mem_required: _Optional[_Union[ResourceQuantity, _Mapping]] = ..., duration: _Optional[str] = ..., deadline: _Optional[str] = ...) -> None: ...
